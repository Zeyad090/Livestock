...
import zeyad.app.livestock.databinding.FragmentLionBinding


class LionFragment : Fragment() {
    private val lineLiveData = MutableLiveData<String>()
 ...
 lateinit var binding :FragmentLionBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLionBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.backLione.setOnClickListener {
            findNavController().navigate(R.id.action_lineFragment_to_livestockFragment)
        }

        val line = resources.getStringArray(R.array.line)
        val arrayAdapter = ArrayAdapter(requireContext(), R.layout.dropdown_items,line)
        ...
        binding.mune.editText?.doOnTextChanged { text, _, _, _ ->
            lineLiveData.value = text.toString()
        }
        ...
        isValidLiveData.observe(viewLifecycleOwner) { isValid ->
            ...
            binding.lineButton.isEnabled = isValid
    ...
    private fun validateform(
        ...
        val isValidLine = line != null && line.isNotBlank()
        ...
        return isValidLine && isValidNumber && isValidType && isValidSim
    }
