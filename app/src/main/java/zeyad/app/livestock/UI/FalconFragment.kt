...
import zeyad.app.livestock.databinding.FragmentFalconBinding


class FalconFragment : Fragment() {
    private val falconLiveData = MutableLiveData<String>()
    ...
    lateinit var binding: FragmentFalconBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFalconBinding.inflate(inflater,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.backFalcon.setOnClickListener {
            findNavController().navigate(R.id.action_falconFragment_to_birdsFragment)
        }

        val falcon = resources.getStringArray(R.array.falcon)
        val arrayAdapter = ArrayAdapter(requireContext(), R.layout.dropdown_items, falcon)
        ...
        isValidLiveData.observe(viewLifecycleOwner) { isValid ->
            binding.falconButton.isEnabled = isValid
    ...
    private fun validateform(
        ...
        val isValidFalcon = falcon != null && falcon.isNotBlank()
        ...
        return isValidFalcon && isValidNumber && isValidType && isValidSim
    }
}